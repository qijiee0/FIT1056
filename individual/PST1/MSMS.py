...
def find_teachers(term):
    ...
    # In term of both name and specialized instrument.
    for teacher in teacher_db:
...
def main():
    ...
    add_teacher("Mr, Beethoven", "Violin")
    #student"s data
    front_desk_register("Wong", "Piano")
    ...
    while True:
        ...
        if choice == '1':
            ...
            #To get a list of students, enter '4'
        elif choice == '4':
            list_students()

            #To get a list of teachers, enter '5'
        elif choice == '5':
            list_teachers()
